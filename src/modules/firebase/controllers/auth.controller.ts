...
export class AuthController {
  ...
  @Patch(':uid')
  @Public()
  @ApiOperation({ summary: 'Actualizar solo el correo de un usuario en Firebase' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Correo actualizado correctamente.' })
  @ApiResponse({ status: HttpStatus.BAD_REQUEST, description: 'Error al actualizar el correo.' })

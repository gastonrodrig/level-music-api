...
import { Assignation, EventSubtask, EventTask } from '../schema';
...
export class AssignationsService {
  constructor(
    ...
    private readonly eventTaskModel: Model<EventTask>,
    @InjectModel(EventSubtask.name)
    private readonly eventSubtaskModel: Model<EventSubtask>,
  ) {}
